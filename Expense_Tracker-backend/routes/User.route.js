...
userRoute.put("/api/v1/user/update-password",isAuthenticated, userController.updatePassword);
userRoute.put("/api/v1/user/update-profile",isAuthenticated, userController.updateProfile);
